...
from layers import Squash
from capsule_dropout import Capsule_Dropout
...
class TransformerEncoderLayer(Module):
    ...
    def __init__(self, d_model, nhead, bidirectional=True, dropout=0, activation="gelu"):
        ...
        self.norm2 = Squash(d_model)
        self.dropout1 = Capsule_Dropout(dropout)
        self.dropout2 = Capsule_Dropout(dropout)
